...
% Toosi et al. 2014
%
% - Interoperabilität von Cloud-Umsetzungen
%	- föderierte Cloud-Anwendungen
% - Motivation
%	- Skalierbarkeit und weitere Verfügbarkeit von Ressourcen
%		- Cloudanbieter müssen viel veranschlagen -> Kosten für Anbieter
%		- Spitzen können einzelnen Anbieter dennoch überfordern
%	- Vermeidung der Abhängigkeit von bestimmten Anbietern
%		- Nachteil von Cloud-Lösungen
%		- einheitliche Schnittstellen -> leichtere Migration
%	- Verfügbarkeit: bei Problemen wie Stromausfall
%	- Zugang: mehrere Standpunkte -> geringere Latenz
%	- Gesetzliche oder Unternehmensregeln: regional beschränktes Hosting
%	- Kosteneffizienz und Energiesparen: interessant für Anbieter
% - Schwierigkeit: u.a. uneinheitliche Standards verschiedener Anbieter
